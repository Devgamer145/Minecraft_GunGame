...
public class Level_54 implements KitInventory {
    ...
    public void load(Player player) {
        ...
        player.getInventory().setItem(0, new ItemBuilder(Material.DIAMOND_AXE, 1).addEnchant(Enchantment.DAMAGE_ALL,1).build());
        ...
        player.getInventory().setHelmet(new ItemBuilder(Material.DIAMOND_HELMET,1).setName(" ").build());
    }
}

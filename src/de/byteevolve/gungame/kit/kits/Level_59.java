...
public class Level_59 implements KitInventory {
    ...
    public void load(Player player) {
        ...
        player.getInventory().setLeggings(new ItemBuilder(Material.DIAMOND_LEGGINGS,1).setUnbreakable(true).addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL,1).setName(" ").build());

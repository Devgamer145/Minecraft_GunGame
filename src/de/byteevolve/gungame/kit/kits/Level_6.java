...
public class Level_6 implements KitInventory {
    ...
    public void load(Player player) {
        ...
        player.getInventory().setItem(0, new ItemBuilder(Material.WOOD_AXE, 1).addEnchant(Enchantment.DAMAGE_ALL,1).build());
        ...
        player.getInventory().setBoots(new LeatherBuilder(Material.LEATHER_BOOTS," ").setCount(1).setColor(Color.TEAL).build());
        player.getInventory().setHelmet(new LeatherBuilder(Material.LEATHER_HELMET," ").setCount(1).setColor(Color.TEAL).build());
    }
}

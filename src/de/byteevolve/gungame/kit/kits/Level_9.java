...
public class Level_9 implements KitInventory {
    ...
    public void load(Player player) {
        ...
        player.getInventory().setLeggings(new LeatherBuilder(Material.LEATHER_LEGGINGS," ").setCount(1).setUnbreakable(true).setColor(Color.TEAL).build());
        ...
        player.getInventory().setHelmet(new LeatherBuilder(Material.LEATHER_HELMET," ").setCount(1).setUnbreakable(true).setColor(Color.TEAL).build());
    }
}

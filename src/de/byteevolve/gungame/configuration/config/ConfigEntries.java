...
public enum ConfigEntries implements ConfigEntry {
    ...
    TARGETTEAMINVITE(ConfigSections.MESSAGES, "targetteaminvite", "&7Du wurdest von&a %PLAYER% &7zu einem &aTeam &7eingeladen(&2/team accept&7).", "&7Du wurdest von&a %PLAYER% &7zu einem &aTeam &7eingeladen.",  "Nachricht an den eingeladenen Spieler \n %PLAYER% = Inhaber des Teams"),
